...
// Integration!
  ...
  const initUser = () => {
    ...
    return (
      <div style={{height: "auto"}}>
        ...
        <div
          style={{
            width: "50%", height: "auto", border: "4px solid blue", borderRadius: "10px", display: "block", padding:"2vh", margin: "auto", position: "relative", backgroundColor: "#defed0d4", }}
        >
          <h3
            style={{
      ...
      <button
          style={{
            height: "6vh", width: "20%", margin: "5px 10px", backgroundColor: "Teal", color: "white", borderRadius: "5px", cursor: "pointer", border: "0px", fontSize: "1rem", }}
          onClick={deposit}
        >
          Deposit 1 ETH
        </button>
        <button
          style={{
            height: "6vh", width: "20%", margin: "5px 10px", backgroundColor: "#8B008B", color: "white", borderRadius: "5px", cursor: "pointer", border: "0px", fontSize: "1rem", }}
          onClick={withdraw}
        >
          Withdraw 1 ETH
        </button>
        ...
        <button
          style={{
            height: "6vh", width: "15%", margin: "10px 20px", backgroundColor: "#5d53a8", color: "white", borderRadius: "5px", cursor: "pointer", border: "0px", fontSize: "1rem",
          }}
          onClick={() => {
            {
              const content = document.getElementById("content");
  ...
  return (
    <main className="container">
      <header><h1 style={{color: "blue", fontFamily:"Poppins"}}>Welcome to the Maskcrafter's wallet!</h1></header>
      {initUser()}
      <style jsx>{`
        .container {
          text-align: center
